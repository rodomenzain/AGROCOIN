...
uint256 hashGenesisBlock("0xd3e775371fcd45b9894ff58fe909a5050742a12e14f99172a1eee0aca45a6b8e");
...
const string strMessageMagic = "Agrocoin Signed Message:\n";
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Agrocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf2faa1fb90f4987989b9dcb635174a2f069bdf46fc5ca1029af07a18edb0c381");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Amar hidroponia crea un inovador sistema de inversion, Agrocoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1517651947; 
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1310906;

        if (fTestNet)
        {
            block.nTime    = 1511111111;
            block.nNonce   = 3056374;
        }

        printf("%s\n", block.GetHash().ToString().c_str());
        printf("%s\n", hashGenesisBlock.ToString().c_str());
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        assert(block.hashMerkleRoot == uint256("0xcc086904d95626e4b4486ff0d4aefbc7f961f91c6dbcae729bbead1b05d4e580"));
